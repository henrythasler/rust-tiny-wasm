...
fn test_parameters() -> Result<()> {
    ...
    let func = instance.get_function::<(i32, i32, i32), i32>("get_third_i32")?;
    let res = func.call(1000, 24, 42)?;
    assert_eq!(res, 42);

    let func = instance.get_function::<(i64, i64), i64>("get_second_i64")?;
    let res = func.call(100000, 0x1234567890aabbcc)?;
    assert_eq!(res, 0x1234567890aabbcc);

    let func = instance.get_function::<(i64, i64, i64, i64), i64>("get_fourth_i64")?;
