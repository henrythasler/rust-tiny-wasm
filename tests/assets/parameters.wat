(module
  (export "get_const_i32" (func $get_const_i32))
  (func $get_const_i32 (result i32)
    i32.const 42
  )

  (export "get_const_i64" (func $get_const_i64))
  (func $get_const_i64 (result i64)
    i64.const 1234567890000
  )
